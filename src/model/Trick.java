...
public class Trick
{
	 ...
	 * 
	 * @param suitCards
	 *            the cards of the suit we are looking for. All of the cards must be of the same
	 *            suit. suitCards should not be empty.
	...
	public int determineWinner ( Suit trump )
	{
		if (trump != Suit.NOTRUMP)
		{
			...
			if (trumpCards.size() > 0) { return getHighCardPlayer(trumpCards); }
		}
	 ...
	 * 
	 * @param pos
	 *            the position of the player whose card is removed.
	 */
