...
{
	private int m_maximumLines;
	private boolean m_isRemoveFromStart;
	...
	public LimitLinesDocumentListener(int maximumLines, boolean isRemoveFromStart)
	{
		...
		this.m_isRemoveFromStart = isRemoveFromStart;
	}
	...
	public void setLimitLines(int maximumLines)
	{
		...
		this.m_maximumLines = maximumLines;
	}
	...
	private void removeLines(DocumentEvent e)
	{
		...
		while (root.getElementCount() > m_maximumLines)
		{
			if (m_isRemoveFromStart)
			{
