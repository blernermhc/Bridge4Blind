...
/**
 * The DirectionGUI allows the sighted player to specify one of four cardinal directions.
 *
...
public abstract class DirectionGUI extends JPanel implements ActionListener
{
	 ...
	 * 
	 * @param title
	 *            the prompt to display above the buttons
	 */
	...
	/**
	 * Creates the panel containing the buttons used to indicate the visually-impaired player's
	 * position.
	 * 
	 * @return A panel containing appropriately-placed "North," "South," "East" and "West" buttons.
	 */
