...
public class Player {
	...
	/**
	 * Checks that the card matches the suit led.  If it does not, it makes
	 * sure that the player has no cards of the led suit.
	 * @param card the card being played
	 * @param ledSuit the suit led in this trick
