...
public class SoundManager {
	...
	public synchronized void addSound(String filename) {
		//System.out.println("SoundManager.addSound: Thread " + Thread.currentThread().getName() + " got lock in playSounds");
		toPlay.add(filename);
		//System.out.println("SoundManager.addSound: Thread " + Thread.currentThread().getName() + " releasing lock");
	}
			...
			soundThread = new Thread("Sound Player"){
				...
				public void run(){
					...
					synchronized(SoundManager.this) {
						//System.out.println("SoundManager.playSounds: Thread " + Thread.currentThread().getName() + " got lock in soundThread's run");
						...
						stopRequested = false;
						//System.out.println("soundThread's run: Thread " + Thread.currentThread().getName() + " releasing lock");
					}
				}
			};
	...
	public synchronized void clearSounds() {
		//System.out.println("SoundManager.clearSounds: Thread " + Thread.currentThread().getName() + " got lock in clearSounds");
		toPlay.clear();
		//System.out.println("SoundManager.clearSounds: Thread " + Thread.currentThread().getName() + " releasing lock");
	}
