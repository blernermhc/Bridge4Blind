...
import controller.DummyHandAntenna;
...
public class Game {
	...
	public Game() {
		...
		handler = new DummyHandler(new CardDatabase());
	...
	public void activateAntennas()
		...
		DummyHandAntenna[] handAntennas = new DummyHandAntenna[NUM_PLAYERS];
		Direction[] directions = Direction.values();
		for (int i = 0; i < players.length; i++) {
			handAntennas[i] = new DummyHandAntenna(directions[i], this);
		}
