...
public class ScanDummyGUI extends JPanel implements GameListener {
	...
	public void dummyHandScanned() {
		...
		clubsScanned.setText(clubsScanned.getText());
		heartsScanned.setText(heartsScanned.getText());
		diamondsScanned.setText(diamondsScanned.getText());
		spadesScanned.setText(spadesScanned.getText());
